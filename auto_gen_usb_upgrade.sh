...
cp image/output/images/boot/u-boot.img.bin board/ifado/boot/usb/upgrade/uboot/
cp image/output/images/boot/IPL.ifado_nand.bin board/ifado/boot/usb/upgrade/ipl/
./image/makefiletools/script/make_usb_factory_sigmastar.sh -i IPL.ifado_nand.bin -u u-boot.img.bin -f
