...
#define INPUT_NAME_0    "./resource/input/ive/1280x720_U8C1_round.bin"
#define INPUT_NAME_1    "./resource/input/ive/1280x720_U8C1_square.bin"
#define OUTPUT_PATH     "./out/ive/"
#define OUTPUT_NAME     "./out/ive/Output_Xor_1280x720_U8C1.bin"
