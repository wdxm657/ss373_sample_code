...
#define INPUT_NAME   "./resource/input/ive/1280x720_U8C1_all_2.bin"
#define OUTPUT_PATH  "./out/ive/"
#define OUTPUT_NAME  "./out/ive/Output_Integ_1280x720_U64C1.bin"
...
int main()
{
    ...
    ret = ST_Common_IveAllocateImage(&dst, E_MI_IVE_IMAGE_TYPE_U64C1, RAW_WIDTH, RAW_WIDTH, RAW_HEIGHT);
    if (ret != MI_SUCCESS)
    {
