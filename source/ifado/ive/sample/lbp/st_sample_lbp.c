...
#define INPUT_NAME_0   "./resource/input/ive/1280x720_U8C1_Img0.bin"
#define OUTPUT_PATH     "./out/ive/"
#define OUTPUT_NAME     "./out/ive/Output_LBP_1280x720_U8C1.bin"
...
int main()
{
    ...
    MI_IVE_SrcImage_t src0;
    MI_IVE_DstImage_t dst;
    MI_IVE_LbpCtrrl_t ctrl;

    ctrl.eMode = E_MI_IVE_LBP_CMP_MODE_NORMAL;  //E_MI_IVE_LBP_CMP_MODE_ABS_MUL,

    ctrl.chMode = E_MI_IVE_LBP_CHAL_MODE_U8C1;


    ctrl.un8BitThr.s8Val = 1;
    ctrl.un8BitThr.u8Val = 1;
    ...
    ret = MI_IVE_Lbp(handle, &src0, &src0, &dst, &ctrl, 0);
    if (ret != MI_SUCCESS)
    {
