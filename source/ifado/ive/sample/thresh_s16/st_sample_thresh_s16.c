...
#define OUTPUT_NAME  "./out/ive/Output_Thresh_S16_1280x720_U8C1.bin"
...
int main()
{
    ...
    ctrl.eMode = E_MI_IVE_THRESH_S16_MODE_S16_TO_S8_MIN_MID_MAX;
    ctrl.s16LowThr = -10922;
    ctrl.s16HighThr = 10922;
    ctrl.un8MinVal.s8Val = 0;
    ctrl.un8MinVal.u8Val = 0;
    ctrl.un8MidVal.s8Val = 127;
    ctrl.un8MidVal.u8Val = 127;
    ctrl.un8MaxVal.s8Val = 255;
    ctrl.un8MaxVal.u8Val = 255;
    ...
    ret = ST_Common_IveAllocateImage(&src, E_MI_IVE_IMAGE_TYPE_S16C1, RAW_WIDTH, RAW_WIDTH, RAW_HEIGHT);
    if (ret != MI_SUCCESS)
    {
