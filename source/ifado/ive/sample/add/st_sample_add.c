...
#define INPUT_NAME_1    "./resource/input/ive/1280x720_U8C1_round_64.bin"
#define OUTPUT_PATH     "./out/ive/"
#define OUTPUT_NAME     "./out/ive/Output_Add_1280x720_U8C1.bin"
...
int main()
{
    ...
    {
        .eMode = E_MI_IVE_ADD_MODE_ROUNDING,  //E_MI_IVE_ADD_MOD_CLIPPING,
        .u0q16X = 32816,
        .u0q16Y = 32720
    };
