...
#define OUTPUT_NAME_HORIZONTAL  "./out/ive/Output_NormGrad_Horizontal_1280x720_S8C1.bin"
#define OUTPUT_NAME_VIRTICAL    "./out/ive/Output_NormGrad_Vertical_1280x720_S8C1.bin"
#define OUTPUT_NAME_COMBINE     "./out/ive/Output_NormGrad_Combine_1280x720_S8C2.bin"
...
int main()
{
    ...
    ret = ST_Common_IveAllocateImage(&dst_h, E_MI_IVE_IMAGE_TYPE_S8C1, RAW_WIDTH, RAW_WIDTH, RAW_HEIGHT);
    if (ret != MI_SUCCESS)
    {
    ...
    ret = ST_Common_IveAllocateImage(&dst_v, E_MI_IVE_IMAGE_TYPE_S8C1, RAW_WIDTH, RAW_WIDTH, RAW_HEIGHT);
    if (ret != MI_SUCCESS)
    {
    ...
    ret = ST_Common_IveAllocateImage(&dst_c, E_MI_IVE_IMAGE_TYPE_S8C2_PACKAGE, RAW_WIDTH, RAW_WIDTH, RAW_HEIGHT);
    if (ret != MI_SUCCESS)
    {
        printf("Can't allocate virtual output buffer\n");
    ...
    ret = ST_Common_IveSaveOutputImage(&dst_c, OUTPUT_NAME_COMBINE);
    if (ret != MI_SUCCESS)
    {
