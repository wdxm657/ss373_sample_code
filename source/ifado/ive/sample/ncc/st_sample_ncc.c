...
#define INPUT_NAME_1    "./resource/input/ive/1280x720_U8C1_outdoor_f01.bin"
#define OUTPUT_PATH     "./out/ive/"
#define OUTPUT_NAME     "./out/ive/Output_NCC_NccDstMem_t.bin"
...
int main()
{
    ...
    ret = ST_Common_IveAllocateBuffer(&dst, sizeof(MI_IVE_NccDstMem_t));
    if (ret != MI_SUCCESS)
    {
        printf("Can't allocate input buffer 1\n");
    ...
    ret = ST_Common_IveSaveOutputBuffer(&dst, OUTPUT_NAME, sizeof(MI_IVE_NccDstMem_t));
    if (ret != MI_SUCCESS)
    {
