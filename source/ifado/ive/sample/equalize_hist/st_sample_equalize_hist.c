...
#define OUTPUT_NAME  "./out/ive/Output_EqualizeHist_1280x720_U8C1.bin"
#define HIST_NAME    "./out/ive/Output_EqualizeHist_EqualizeHistCtrlMem_t.bin"
...
int main()
{
    ...
    ret = ST_Common_IveAllocateBuffer(&ctrl.stMem, sizeof(MI_IVE_EqualizeHistCtrlMem_t));
    if (ret != MI_SUCCESS)
    {
        printf("Can't allocate output buffer\n");
    ...
    ret = ST_Common_IveSaveOutputBuffer(&ctrl.stMem, HIST_NAME, sizeof(MI_IVE_EqualizeHistCtrlMem_t));
    if (ret != MI_SUCCESS)
    {
